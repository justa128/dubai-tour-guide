...
public class FoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categories.add(new Category(getString(R.string.wheather), R.drawable.dubai_at_night));
        categories.add(new Category(getString(R.string.when_come), R.drawable.dubai_at_night));
        categories.add(new Category(getString(R.string.dress_code), R.drawable.dubai_at_night));
